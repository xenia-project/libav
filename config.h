...
#define LIBAV_CONFIGURATION "--toolchain=msvc --arch=x86_64 --extra-cflags=-MDd --extra-ldflags=user32.lib --disable-everything --disable-programs --disable-all --enable-avcodec --enable-avutil --enable-decoder=wmapro --enable-hardcoded-tables --prefix=/E/Dev/Repositories/xenia/third_party/libav"
#define LIBAV_LICENSE "LGPL version 2.1 or later"
#define AVCONV_DATADIR "/E/Dev/Repositories/xenia/third_party/libav/share/avconv"
