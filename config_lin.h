...
#define LIBAV_CONFIGURATION "--toolchain=clang-asan --arch=x86_64 --disable-everything --disable-programs --disable-all --enable-avcodec --enable-avutil --enable-decoder=wmapro --disable-yasm"
#define LIBAV_LICENSE "LGPL version 2.1 or later"
#define AVCONV_DATADIR "/usr/local/share/avconv"
#define CC_IDENT "Debian clang version 3.5.0-10 (tags/RELEASE_350/final) (based on LLVM 3.5.0)"
